...
#         root='/datasets/cv_datasets/data', train=True, download=True, transform=train_transform)
#     test_dataset = torchvision.datasets.CIFAR10(
#         root='/datasets/cv_datasets/data', train=False, download=True, transform=test_transform)
...
# def train_encoder_classifier(model, train_loader, test_loader, artifacts_dir, num_epochs=100, learning_rate=0.001):
...
#             torch.save(best_model_state, artifacts_dir / 'best_encoder_classifier.pth')  # Save immediately
...
#     train_loader, test_loader = get_augmented_data_loaders(batch_size=128)
    
#     # Initialize the encoder+classifier model
#     embedding_dim = 128
    
#     model = EncoderClassifier(embedding_dim=embedding_dim)
#     print(f"Training encoder+classifier model...")
    
#     # Train the encoder+classifier end-to-end
